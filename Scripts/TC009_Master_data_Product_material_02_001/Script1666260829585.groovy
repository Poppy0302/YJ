...
WebUI.setText(findTestObject('Master_data_Product_material/Product Data/input_Color_productcolor'), 'Sky')
...
WebUI.setText(findTestObject('Master_data_Product_material/Product Data/input_PO-C List_qtext_search'), '000'+ RD)

WebUI.sendKeys(findTestObject('Master_data_Product_material/Product Data/input_PO-C List_qtext_search'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Master_data_Product_material/Product Data/a_View Detail'))

WebUI.click(findTestObject('Master_data_Product_material/Product Data/i_Qty_fas fa-trash-alt cursor-pointer (1)'))

WebUI.click(findTestObject('Master_data_Product_material/Product Data/input_Please fill TH Price_commit'))
