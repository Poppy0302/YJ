...
WebUI.click(findTestObject('Receive QC/input_Scan barcode_input-receive'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Receive QC/input_Scan barcode_input-receive'), '72-2117')

WebUI.sendKeys(findTestObject('Receive QC/input_Scan barcode_input-receive'), Keys.chord(Keys.ENTER))
